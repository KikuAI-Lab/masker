...
class TestMaskEndpoint:
    ...
    def test_mask_email(self, client: TestClient):
        ...
        response = client.post(
            "/api/v1/mask", json={"text": "Contact me at test@example.com please"}
        )
    ...
    def test_mask_phone(self, client: TestClient):
        ...
        response = client.post("/api/v1/mask", json={"text": "Call +1-555-123-4567 now"})
    ...
    def test_mask_card(self, client: TestClient):
        ...
        response = client.post("/api/v1/mask", json={"text": "Pay with card 4111-1111-1111-1111"})
    ...
    def test_mask_no_pii(self, client: TestClient):
        ...
        response = client.post("/api/v1/mask", json={"text": original})
    ...
    def test_mask_preserves_structure(self, client: TestClient):
        ...
        response = client.post("/api/v1/mask", json={"text": "Before test@example.com After"})
    ...
    def test_mask_empty_text_rejected(self, client: TestClient):
        ...
        response = client.post("/api/v1/mask", json={"text": ""})
    ...
    def test_mask_with_language(self, client: TestClient):
        ...
        response = client.post(
            "/api/v1/mask", json={"text": "Email: test@example.ru", "language": "ru"}
        )
