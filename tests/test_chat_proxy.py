...
class TestChatCompletionsAuth:
    ...
    def test_missing_api_key_returns_401(self, client: TestClient, monkeypatch):
        ...
        # (Need to reload app to apply config changes in real test)
...
class TestChatCompletionsProxy:
    ...
    @pytest.mark.asyncio
    async def test_redacts_pii_in_messages(self):
    ...
    @pytest.mark.asyncio
    async def test_hash_value_function(self):
    ...
    @pytest.mark.asyncio
    async def test_apply_redaction_action_mask(self):
    ...
    @pytest.mark.asyncio
    async def test_apply_redaction_action_placeholder(self):
    ...
    @pytest.mark.asyncio
    async def test_apply_redaction_action_drop(self):
    ...
    @pytest.mark.asyncio
    async def test_apply_redaction_action_keep(self):
